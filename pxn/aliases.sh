...
alias wz='watch -d -n 2 "zpool iostat -v | sed \\"/^\s*$/d\\" ; zpool status | sed \\"/^\s*$/d\\" | grep -v errors\\:\\ No\\ known\\ data\\ errors ; echo ; df -h ; zfs get compressratio | grep --invert-match --color=none 1.00"'
